...
<tr>
	<td>Title:</td>
	<td><input type="text" id="title" name="title" value="这里是标题" style="width:380px;" /></td>
</tr>
<tr>
	<td>Message:</td>
	<td><textarea id="message" name="message" style="width:380px; height:80px;" >测试推送信息</textarea></td>
</tr>
<%--
<tr>
	<td>Ticker:</td>
...
<tr>
	...
	<td><input type="text" id="uri" name="uri" value="" style="width:380px;" />
	    <br/><span style="font-size:0.8em">http://newsmth.org</span>
	</td>
</tr>
<tr>
	<td>&nbsp;</td>
