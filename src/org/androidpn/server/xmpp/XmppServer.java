    ...
    public static XmppServer getInstance() {
        ...
        if (instance == null) {
            synchronized (XmppServer.class) {
            	if( instance == null ){ // add double check by ade
    ...
    public void start() {
        try {
          ...
          //  locateServer();
            ...
            context = new ClassPathXmlApplicationContext(new String[]{"mina.xml", "spring-config.xml"});
            log.info("Spring Configuration loaded.");
            log.info("Androidpn Server v" + version);
            
            /**
             * see spring load all context, by ade..
             */
//            String[] names = context.getBeanDefinitionNames();
//            for( String n: names){
//            	log.info(n + "->" + context.getBean(n));
//            }
